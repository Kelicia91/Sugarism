...
{
    /// <summary>
    /// ListView fills with Columns.
    /// </summary>
    public class ListViewLayout : DependencyObject
    {
        public static readonly DependencyProperty StretchProperty =
            DependencyProperty.RegisterAttached("Stretch", typeof(Boolean), typeof(ListViewLayout),
